...
@section('content')
    <div class="container">
        <div class="row">
                <div class="col pt-5">
                    <h2 class="text-success display-3">Bootstrap</h2>
                    <p class="lead pt-2 px-2">
                ...
                <div class="col-md px-4">
                    <a href="" class="btn btn-lg btn-outline-secondary w-100 mb-3">Download</a>
                </div>
            </div>
