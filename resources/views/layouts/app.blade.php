...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel navbar-success bg-success">
            <div class="d-flex justify-content-between">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link text-dark">Documentation</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-dark">Examples</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-dark">Icons</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-dark">Themes</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link text-dark">Expo</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @guest
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-md-right" aria-labelledby="bd-versions">
                                    <a class="dropdown-item" href="/docs/4.4/">Latest (4.4.x)</a>
                            ...
                            <li class="nav-item" style="margin-top: -9px;">
                                <a class="nav-link p-2" href="" target="_blank" rel="noopener" aria-label="GitHub"></a>
                            ...
                            <li class="nav-item ml-3" style="margin-top: -10px;">
                                <a class="nav-link p-2" href="" target="_blank" rel="noopener" aria-label="GitHub"></a>
                            ...
                            <li class="nav-item ml-3">
                                <button class="btn btn-outline-light">Download</button>
                            </li>
                        <!-- <li class="nav-item">
